...
<tr valign="top" <?php echo ($section_class ? 'class="'.$section_class.'"' : ''); echo ($section_id ? "id='{$section_id}'" : ''); ?>>
    ...
    <?php foreach( $options as $option ): ?>
        <?php if($option['checked']): ?>
            <input id="<?php echo $option['value']; ?>" type="checkbox" name="<?php echo $name; ?>" value="<?php echo $option['value']; ?>" checked="checked" /> <?php echo $option['title']; ?>
        <?php else: ?>
            <input id="<?php echo $option['value']; ?>" type="checkbox" name="<?php echo $name; ?>" value="<?php echo $option['value']; ?>" <?php if ( htmlentities( $this->value, ENT_QUOTES ) == $option['value'] ) echo ' checked="checked"'; ?> /> <?php echo $option['title']; ?>
        <?php endif; ?>
